...
export default function StatsWithIcons() {
  ...
  return (
    <section style={{backgroundImage:"url(/bg-wave.webp)"}} className="hidden md:block bg-center bg-cover py-16">
          ...
          >
            ...
            <div className="relative w-16 h-16 mb-4 perspective">
              <div className="w-full h-full transition-transform duration-500 transform group-hover:rotate-y-180">
                <div className="absolute inset-0 flex items-center justify-center text-[#FF9100] backface-hidden">
                  {item.icon}
                </div>
                <div className="absolute  inset-0 flex items-center justify-center text-[#FF9100] rotate-y-180 backface-hidden">
                  {item.icon}
                </div>
              </div>
            </div>
